  ...
  <body data-spy="scroll" data-target=".navbar-collapse">
      ...
      <div class="container">
        ...
        <div class="pull-right">
          <ul class="navbar-nav nav">
            <li><a href="projectSecretDiaryForm.php?logout=1">Log Out</a></li>
          </ul>
    ...
    <script>
      ...
      $("textarea").keyup(function(){
        //alert("changed");
        $.post("projectSecretDiaryUpdate.php", {diary:$("textarea").val()});
      });
    </script>
  </body>
</html>
...
<!--<?/*include("projectSecretDiaryLogin.php");?>
<form method="post">
